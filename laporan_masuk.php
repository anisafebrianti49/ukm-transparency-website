...
$pdf->Cell(0,10,'LAPORAN KAS MASUK UKM ENGLISH CLUB',0,1,'C');
...
$query = mysqli_query($conn,"SELECT * FROM kas_masuk ORDER BY tanggal ASC");
...
$pdf->Cell(40,8,'TOTAL KAS MASUK : ',0,0,'L');
